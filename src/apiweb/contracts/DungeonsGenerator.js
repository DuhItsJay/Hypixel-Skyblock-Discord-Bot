const weights = require('../../utils/constants/weight').dungeonsWeight
const DungeonsExperience = require('../../utils/constants/leveling').dungeoneering_xp
	...
	execute(profile) {
		...
		const dungeons = {
			...
			classes: {
				...
				berserk: generateClassProperties('berserk', dungeonGroups.player_classes.berserk || 0),
			...
			types: {
				catacombs: buildDungeonTypeProperties('catacombs', dungeonGroups.dungeon_types.catacombs, dungeonGroups.dungeon_types.master_catacombs),
			},
		}
